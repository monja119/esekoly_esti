        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                <div class="card-body">
                    ...
                    <form method="POST" action="/sac/edt/add/">
                        <div class="input-group">
                            <label for="classe">Classe</label>
                            <input class="input--style-1" type="text" placeholder="ex: L1G2" name="niveau">
                        </div>
                        <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-1 js-datepicker" type="time" placeholder="Début" name="heure_debut">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-1 js-datepicker" type="time" placeholder="Fin" name="heure_fin">
                                    <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
                                </div>
                            </div>
                        </div>
                        <div class="input-group">
                            ...
                            <input class="input--style-1" type="text" placeholder="Numéro Salle" name="numero_salle">
                        </div>
                        <div class="p-t-20">
