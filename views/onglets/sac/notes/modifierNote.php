            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="<?= '/sac/notes/update/?note_id='.$note['id'].'&enseignant_id='.$module['enseignant_id'].'&module_id='.$module['module_id'] ?>" method="post">
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        <td>
                                            <input
                                                    value="<?= $note['user_id'] ?>"
                                                    type="number" name="etudiant" class="form-control" placeholder="Matricule Etudiant" required>
                                        </td>
                                        <td>
                                            <input  value="<?= $note['note'] ?>"
                                                    type="number" name="note_obtenue" class="form-control" placeholder="Note Obtenue" required>
                                        </td>
                                        <td>
                                            <input  value="<?= $note['note_max'] ?>"
                                                    type="number" name="sur" class="form-control" placeholder="Sur" required>
                                        </td>
                                    </tr>
                                    </tbody>
                                    <tfoot>
